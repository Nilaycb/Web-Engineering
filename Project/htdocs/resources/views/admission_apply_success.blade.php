    ...
    <div id="contact" class="section wb">
        <div class="container">
            <div class="section-title text-center">
                <h3>Application Succesful!</h3>
                <p class="lead">@if(!empty($application_id)) Application ID: {{ $application_id }} @endif @if(isset($application_status) and ($application_status == '')) Application Status: Submitted. @endif</p>
            </div><!-- end title -->
