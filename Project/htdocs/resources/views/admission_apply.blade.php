...
<body class="host_version"> 
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbars-host">
					<ul class="navbar-nav ml-auto">
                        ...
                        @if(Auth::check())
						<li class="nav-item active"><a class="nav-link" href="/admission_apply">Application</a></li>
                        @endif
					</ul>
	...
	<div class="all-title-box">
		<div class="container text-center">
			<h1>Apply for Admission<span class="m_1">Lorem Ipsum dolroin gravida nibh vel velit.</span></h1>
		</div>
	</div>
    ...
    <div id="contact" class="section wb">
        <div class="container">
            <div class="section-title text-center">
                <h3>Apply Online!</h3>
                <p class="lead">Please give us your details. Please fill out the form below.</p>
            </div><!-- end title -->
            ...
            <div class="row">
                <div class="col-xl-6 col-md-12 col-sm-12">
                    <div class="contact_form">
                        <div id="message"></div>
                        <form id="contactform" class="" action="{{ route('admission_apply.store') }}" name="contactform" method="post">
                            @csrf
                            <div class="row row-fluid">
								...
								<div class="col-lg-12 col-md-12 col-sm-12">
                                    <input type="text" name="enroll_in" id="enroll_in" class="form-control" placeholder="Course/Class you want to enroll in">
                                    @error('enroll_in')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <textarea class="form-control" name="details" id="details" rows="6" placeholder="Give us more details.."></textarea>
                                    @error('details')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="text-center pd">
                                    <button type="submit" value="SEND" id="submit" class="btn btn-light btn-radius btn-brd grd1 btn-block">Apply</button>
                                </div>
                            </div>
                        </form>
                    </div>
